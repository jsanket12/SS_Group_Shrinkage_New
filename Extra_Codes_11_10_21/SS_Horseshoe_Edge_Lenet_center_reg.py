...
from Horseshoe_Conv_layers_center_reg import SSHS_Edge_Conv2d_layer, HS_Conv2d_layer
...
parser.add_argument('--results_path', default='./results_lenet_new/mnist/SS_HS/', type = str, help = 'base path for saving result')
...
class SFunc(nn.Module):
    ...
    def __init__(self, hidden_dim1, hidden_dim2, target_dim, temp, gamma_prior, gamma_prior_star1, 
        ...
        self.conv1 = SSHS_Edge_Conv2d_layer(1, 20, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
                                                sig_b_mu = self.sig_b_mu, sig_b_rho = self.sig_b_rho,
                                                kernel_size=5, stride=1, temp=temp, gamma_prior=gamma_prior, sigma_0=sigma_0, tau_1 = tau_1)
        self.conv2 = SSHS_Edge_Conv2d_layer(20, 50, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
                                                sig_b_mu = self.sig_b_mu, sig_b_rho = self.sig_b_rho,
                                                kernel_size=5, stride=1, temp=temp, gamma_prior=gamma_prior, sigma_0=sigma_0, tau_1 = tau_1)
        self.l1 = SSHS_Edge_layer(4*4*50, hidden_dim1, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
                                                sig_b_mu = self.sig_b_mu, sig_b_rho = self.sig_b_rho, 
        ...
        # self.conv1 = HS_Conv2d_layer(1, 20, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
        #                                         sig_b_mu = self.sig_b_mu, sig_b_rho = self.sig_b_rho,
        #                                         kernel_size=5, stride=1, sigma_0=sigma_0, tau_1 = tau_1)
        # self.conv2 = HS_Conv2d_layer(20, 50, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
        #                                         sig_b_mu = self.sig_b_mu, sig_b_rho = self.sig_b_rho,
        #                                         kernel_size=5, stride=1, sigma_0=sigma_0, tau_1 = tau_1)
        # self.l1 = HS_layer(4*4*50, hidden_dim1, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
        #                                     sig_b_mu = self.sig_b_mu, sig_b_rho = self.sig_b_rho, sigma_0=sigma_0, tau_1 = tau_1)
...
def main():
    ...
    net = net = SFunc(hidden_dim1, hidden_dim2, target_dim, temp, gamma_prior, gamma_prior_star1, 
    ...
    m.save(PATH,'results_SS_Horseshoe_Edge_center_reg_Lenet_Caffe_MNIST_silu_0.001_1024_1200')

    torch.save(net.state_dict(), PATH + 'SS_Horseshoe_Edge_center_reg_Lenet_Caffe_MNIST_model_silu_0.001_1024_1200.pt')
    ...
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Horseshoe_Edge_center_reg_Lenet_Caffe_MNIST_loss_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Horseshoe_Edge_center_reg_Lenet_Caffe_MNIST_accuracy_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Horseshoe_Edge_center_reg_Lenet_Caffe_MNIST_sparsity_node_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Horseshoe_Edge_center_reg_Lenet_Caffe_MNIST_sparsity_edge_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
