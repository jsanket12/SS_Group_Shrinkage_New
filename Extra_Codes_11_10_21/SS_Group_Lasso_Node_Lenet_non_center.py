...
def main():
    ...
    # m.save(PATH,'results_SS_Group_Lasso_Node_non_center_Lenet_Caffe_MNIST_silu_0.001_1024_1200')

    # torch.save(net.state_dict(), PATH + 'SS_Group_Lasso_Node_non_center_Lenet_Caffe_MNIST_model_silu_0.001_1024_1200.pt')
    ...
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,"SS_Group_Lasso_Node_non_center_Lenet_Caffe_MNIST_loss_silu_0.001_1024_1200.png"),dpi=300)
    # plt.close()
    ...
    # plt.legend(loc='upper right', frameon=False)
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,"SS_Group_Lasso_Node_non_center_Lenet_Caffe_MNIST_accuracy_silu_0.001_1024_1200.png"),dpi=300)
    # plt.close()
    ...
    # plt.legend(loc='upper right', frameon=False)
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,"SS_Group_Lasso_Node_non_center_Lenet_Caffe_MNIST_sparsity_node_silu_0.001_1024_1200.png"),dpi=300)
    # plt.close()
    ...
    # plt.legend(loc='upper right', frameon=False)
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,"SS_Group_Lasso_Node_non_center_Lenet_Caffe_MNIST_sparsity_edge_silu_0.001_1024_1200.png"),dpi=300)
    # plt.close()
