...
parser.add_argument('--results_path', default='./results_mlp_new/mnist/SS_GHS/', type = str, help = 'base path for saving result')
...
class SFunc(nn.Module):
    ...
    def __init__(self, data_dim, hidden_dim1, hidden_dim2, target_dim, temp, gamma_prior, gamma_prior_star1, 
        ...
        self.l1 = SS_GHS_Node_layer(data_dim, hidden_dim1, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
        ...
        # self.l1 = GHS_layer(data_dim, hidden_dim1, sig_a_mu = self.sig_a_mu, sig_a_rho = self.sig_a_rho, 
        #                                     sig_b_mu = self.sig_b_mu, sig_b_rho = self.sig_b_rho, sigma_0=sigma_0, tau_1 = tau_1)
...
def main():
    ...
    net = SFunc(data_dim, hidden_dim1, hidden_dim2, target_dim, temp, gamma_prior, gamma_prior_star1, gamma_prior_star2, 
    ...
    m.save(PATH,'results_SS_Group_Horseshoe_Node_center_reg_MLP400_MNIST_silu_0.001_1024_1200')

    torch.save(net.state_dict(), PATH + 'SS_Group_Horseshoe_Node_center_reg_MLP400_MNIST_model_silu_0.001_1024_1200.pt')
    ...
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Group_Horseshoe_Node_center_reg_MLP400_MNIST_loss_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Group_Horseshoe_Node_center_reg_MLP400_MNIST_accuracy_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Group_Horseshoe_Node_center_reg_MLP400_MNIST_sparsity_node_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,"SS_Group_Horseshoe_Node_center_reg_MLP400_MNIST_sparsity_edge_silu_0.001_1024_1200.png"),dpi=300)
    plt.close()
