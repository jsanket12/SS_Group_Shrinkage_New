...
from GHS_resnet_models_non_center import GHS_ResNet
from GHS_linear_layers_non_center import GHS_layer
from GHS_Conv_layers_non_center import GHS_Conv2d_layer
...
def main():
    ...
    net = GHS_ResNet(depth=args.depth, num_classes=target_dim, sigma_0 = sigma_0, tau_0 = tau_0).to(device)
    ...
    # m.save(PATH,'results_Group_Horseshoe_Resnet_CIFAR10_silu_lr_decay_'+str(args.batch_train)) 

    # torch.save(net.state_dict(), PATH + 'Group_Horseshoe_Resnet_CIFAR10_model_silu_lr_decay_'+ str(args.batch_train) + '.pt')
    ...
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,'Group_Horseshoe_Resnet_CIFAR10_loss_silu_lr_decay_'+str(args.batch_train)+'.png'),dpi=300)
    # plt.close()
    ...
    # plt.legend(loc='upper right', frameon=False)
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,'Group_Horseshoe_Resnet_CIFAR10_accuracy_silu_lr_decay_'+str(args.batch_train)+'.png'),dpi=300)
    # plt.close()
