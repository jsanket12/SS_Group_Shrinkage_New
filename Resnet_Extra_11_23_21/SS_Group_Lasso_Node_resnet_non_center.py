...
from Group_Lasso_resnet_models_non_center import SS_Group_Lasso_Node_ResNet
from Group_Lasso_linear_layers_non_center import Group_Lasso_layer
from Group_Lasso_Conv_layers_non_center import SS_Group_Lasso_Node_Conv2d_layer
...
def main():
    ...
    m.save(PATH,'results_SS_Group_Lasso_Node_non_center_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)) 
    ...
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_Group_Lasso_Node_non_center_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_loss.png'),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_Group_Lasso_Node_non_center_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_accuracy.png'),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_Group_Lasso_Node_non_center_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_edge_sparsity.png'),dpi=300)
    plt.close()
