...
from GHS_resnet_models_non_center_new import SS_GHS_Node_ResNet
from GHS_linear_layers_non_center import GHS_layer
from GHS_Conv_layers_non_center_new import SS_GHS_Node_Conv2d_layer
...
def main():
    ...
    net = SS_GHS_Node_ResNet(depth=args.depth, num_classes=target_dim, temp = temp, gamma_prior = gamma_prior, sigma_0 = sigma_0, 
                            tau_0 = tau_0, tau_1 = tau_1).to(device)
    ...
    for epoch in range(num_epochs):
        ...
        for batch in train_loader:
            ...
            kl_train += net.kl_sig.div(NTrain)
        ...
        with torch.no_grad():
            ...
            if test_accuracy > best_accuracy:
                ...
                torch.save(net.state_dict(), PATH + 'SS_GHS_Node_non_center_fine_tune_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_seed_'+str(args.seed) + '_best_model.pt')
    ...
    net.load_state_dict(torch.load(PATH + 'SS_GHS_Node_non_center_fine_tune_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_seed_'+str(args.seed) + '_best_model.pt'))
    ...
    for epoch_fine in range(args.fine_tune_nepoch):
        ...
        with torch.no_grad():
            ...
            if test_accuracy > best_accuracy:
                best_accuracy = test_accuracy
                torch.save(net.state_dict(), PATH + 'SS_GHS_Node_non_center_fine_tune_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_seed_'+str(args.seed) + '_final_model.pt')
    ...
    m.save(PATH,'results_SS_GHS_Node_non_center_fine_tune_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_seed_'+str(args.seed)) 

    # torch.save(net.state_dict(), PATH + 'SS_GHS_Node_non_center_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0) + '_model.pt')
    ...
    plt.title('SS_GHS_Node_non_center: Train-Test Loss')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    # plt.ylim([0.55, 1.0])
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_GHS_Node_non_center_fine_tune_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_loss.png'),dpi=300)
    plt.close()

    plt.plot(range(num_epochs), train_Accuracy, 'b', label='Train')
    plt.plot(range(num_epochs), test_Accuracy, 'orange', label='Test')
    plt.title('SS_GHS_Node_non_center: Train-Test Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    # plt.ylim([0.55, 1.0])
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_GHS_Node_non_center_fine_tune_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_accuracy.png'),dpi=300)
    plt.close()

    plt.plot(range(num_epochs), Edge_sparsity, 'g')
    plt.title('SS_GHS_Node_non_center: Edge Sparsity')
    plt.xlabel('Epochs')
    plt.ylabel('Sparsity')
    # plt.ylim([0.65, 1.0])
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_GHS_Node_non_center_fine_tune_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_edge_sparsity.png'),dpi=300)
    plt.close()
