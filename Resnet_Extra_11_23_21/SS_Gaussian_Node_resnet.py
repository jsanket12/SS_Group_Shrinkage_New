...
from Gauss_resnet_models import SSGauss_Node_ResNet
...
parser.add_argument('--results_path', default='./results_resnet_new/cifar10/SS_Gauss_Node/', type = str, help = 'base path for saving result')
...
def main():
    ...
    m.save(PATH,'results_SS_Gaussian_Node_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)) 
    ...
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_Gaussian_Node_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_loss.png'),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_Gaussian_Node_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_accuracy.png'),dpi=300)
    plt.close()
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.grid(ls='dotted')
    plt.savefig(os.path.join(PATH,'SS_Gaussian_Node_RN'+str(args.depth)+'_SGD_batch_'+str(args.batch_train)+'_sig0_'+str(args.sigma_0)+'_edge_sparsity.png'),dpi=300)
    plt.close()
