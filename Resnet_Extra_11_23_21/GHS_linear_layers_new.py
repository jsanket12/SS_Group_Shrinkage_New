...
class SS_GHS_Node_and_Edge_layer(nn.Module):
    ...
    def reset_parameters(self):
        ...
        init.constant_(self.tau_a_rho, -9.)
        init.constant_(self.tau_b_rho, -9.)
...
class GHS_layer(nn.Module):
    def __init__(self, input_dim, output_dim, sig_a_mu, sig_a_rho, sig_b_mu, sig_b_rho, bias=True, clip_std=None, sigma_0=1, tau_1 =1):
        super().__init__()
        # set input and output dimensions
        self.input_dim = input_dim
        self.output_dim = output_dim
