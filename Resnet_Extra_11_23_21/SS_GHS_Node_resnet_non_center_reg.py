...
from GHS_resnet_models_non_center_reg import SS_GHS_Node_ResNet
from GHS_linear_layers_non_center_reg import GHS_layer
from GHS_Conv_layers_non_center_reg import SS_GHS_Node_Conv2d_layer
from GHS_BN_layers_non_center_reg import SS_GHS_VB_BatchNorm2d
...
def main():
    ...
    # m.save(PATH,'results_SS_Group_Horseshoe_non_center_reg_Resnet_CIFAR10_silu_lr_decay_'+str(args.batch_train)) 

    # torch.save(net.state_dict(), PATH + 'SS_Group_Horseshoe_non_center_reg_Resnet_CIFAR10_model_silu_lr_decay_'+ str(args.batch_train) + '.pt')
    ...
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,'SS_Group_Horseshoe_non_center_reg_Resnet_CIFAR10_loss_silu_lr_decay_'+str(args.batch_train)+'.png'),dpi=300)
    # plt.close()
    ...
    # plt.legend(loc='upper right', frameon=False)
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,'SS_Group_Horseshoe_non_center_reg_Resnet_CIFAR10_accuracy_silu_lr_decay_'+str(args.batch_train)+'.png'),dpi=300)
    # plt.close()
    ...
    # plt.legend(loc='upper right', frameon=False)
    # plt.grid(ls='dotted')
    # plt.savefig(os.path.join(PATH,'SS_Group_Horseshoe_non_center_reg_Resnet_CIFAR10_sparsity_edge_silu_lr_decay_'+str(args.batch_train)+'.png'),dpi=300)
    # plt.close()
