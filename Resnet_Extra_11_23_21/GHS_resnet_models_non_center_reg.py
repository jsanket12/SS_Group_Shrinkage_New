...
from GHS_Conv_layers_non_center_reg import SS_GHS_Node_Conv2d_layer, GHS_Conv2d_layer
from GHS_BN_layers_non_center_reg import SS_GHS_VB_BatchNorm2d, GHS_VB_BatchNorm2d
...
def SS_GHS_Node_conv3x3(in_planes, out_planes, stride=1,
...
class SS_GHS_Node_ResNet(nn.Module):
    def __init__(self, depth, num_classes=1000, temp = 0.5, gamma_prior = 0.0001, sigma_0 = 1, tau_0 = 1e-5, tau_1 = 1, c_a = 2, c_b = 6, c_reg = 1):
        ...
        self.inplanes = 16
        self.conv1 = SS_GHS_Node_Conv2d_layer(3, 16, kernel_size=3, padding=1, bias=False, temp=temp, gamma_prior=gamma_prior, sigma_0=sigma_0, tau_1 = tau_1)
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                SS_GHS_Node_Conv2d_layer(self.inplanes, planes * block.expansion, kernel_size=1, stride=stride, bias=False, 
